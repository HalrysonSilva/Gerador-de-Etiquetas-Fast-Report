...
type
  TDataModule1 = class(TDataModule)
    ...
    QRYADCIONAPRODUTO: TUniQuery;
    DSQRYADCIONAPRODUTO: TDataSource;
    QRYULTIMOCONTROLE: TUniQuery;
    DSdbtabetiq: TfrxDBDataset;
    QRYTABETIQ: TUniQuery;
    ETIQBOBINA80X30MM: TfrxReport;
    ETIQ2PRECO105x30mm: TfrxReport;
    QRYLIMPATABETIQ: TUniQuery;
    ETIQPRUNICO105X30mm: TfrxReport;
    ETIQ3CL30X20mm: TfrxReport;
    frxReport1: TfrxReport;
    ETIQ7CL26X15mm: TfrxReport;
...
uses FRMsvetiqueta, FRMSelectproduto;
